...
| **Android** | Выбор экрана (дом / блокировка / оба), только Wi‑Fi; **живые обои EarthPorn** на домашнем экране (наклон, листание страниц лаунчера, три тапа по пустому месту на обоях); фоновое уведомление для смены по расписанию как на ПК |
